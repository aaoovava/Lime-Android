    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (windowManager != null) {
            ...
            if (screenHeight < 2000)  { //small
                ...
                float newVBias = (float)(layoutParamsCon.verticalBias * screenHeight * 0.0001);
                layoutParamsCon.verticalBias = newVBias;
            } else if (screenHeight >= 2500) { //big
                float newBias = (float) (layoutParamsCon.horizontalBias * screenHeight * 0.0004);// Новое значение app:layout_constraintHorizontal_bias
                layoutParamsCon.horizontalBias = newBias;
                float newVBias = (float)(layoutParamsCon.verticalBias * screenHeight * 0.00017);
                layoutParamsCon.verticalBias = newVBias;
            } else { //normall
                ...
                layoutParamsCon.horizontalBias = newBias;
                float newVBias = (float)(layoutParamsCon.verticalBias * screenHeight * 0.0002);
                layoutParamsCon.verticalBias = newVBias;
            ...
            if (screenHeight < 2000) {
                ...
                float newVBias = (float)(layoutParamsConDflt.verticalBias * screenHeight * 0.0001);
                layoutParamsConDflt.verticalBias = newVBias;
                ...
                layoutParamsConDflt.horizontalBias = newBias;
                float newVBias = (float)(layoutParamsConDflt.verticalBias * screenHeight * 0.0002);
                layoutParamsConDflt.verticalBias = newVBias;
            }
